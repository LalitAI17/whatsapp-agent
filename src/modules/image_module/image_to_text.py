...
async def example_usage():
    ...
    # Example 2: Analyze an image from binary data
    try:
        with open("generated_images/lake_sunset.png", "rb") as f:
            image_bytes = f.read()
        
        description = await image_to_text.analyze_image(image_bytes)
